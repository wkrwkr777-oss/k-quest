...
import { Crown, Mail, Lock, ArrowRight, Chrome } from 'lucide-react';
...
export default function SignIn() {
    ...
    const handleSignIn = async (e: React.FormEvent) => {
        ...
        // Mock login for immediate testing
        setTimeout(() => {
            if (email && password) {
    ...
    return (
        <div className="min-h-screen bg-[#0A0A0A] flex items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-1/4 -left-1/4 w-1/2 h-1/2 bg-[#D4AF37]/10 rounded-full blur-3xl animate-pulse" />
            ...
            <div className="w-full max-w-md relative z-10">
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-400">Sign in to access your premium concierge</p>
                </div>
                    ...
                    <div className="mt-8">
                        ...
                        <div className="grid grid-cols-2 gap-4 mt-6">
                            <button
                                ...
                                className="flex items-center justify-center gap-2 px-4 py-3 bg-[#262626] border border-[#333] rounded-xl text-white hover:bg-[#333] transition-colors"
                            >
                            ...
                            <button
                                ...
                                className="flex items-center justify-center gap-2 px-4 py-3 bg-[#FEE500] border border-[#FEE500] rounded-xl text-[#000000] hover:bg-[#FDD835] transition-colors font-bold"
                            >
                ...
                <p className="text-center mt-8 text-gray-400">
                    ...
                    <Link href="/auth/signup" className="text-[#D4AF37] font-bold hover:underline">
                        Sign up for free
                    </Link>
                </p>
            </div>
